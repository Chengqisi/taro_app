...
var Index = function Index() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])([{
    ...
    navigateUrl: '/sub_webView/index?url=https://developer.mozilla.org/zh-CN/docs/Web/Tutorials',
    cardTitle: 'MDN',
    imgUrl: 'https://img0.baidu.com/it/u=2372778491,4047794861&fm=253&fmt=auto&app=138&f=JPEG?w=800&h=450',
    introduce: '不管你是仅仅开始入门、学过些基础或者是个网站开发老手，你都能在这里找到有用的资源加以绝佳的练习。这些资源都来自卓有远见的公司和乐于接受开放标准网站开发人员'
  }]),
